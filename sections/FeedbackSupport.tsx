...
const FeedbackSupport = () => { const router = useRouter()
...
{/* Header */}
    <div className="mb-8">
      ...
      <p className="text-slate-400 text-base max-w-2xl">
        Have questions or interested in cooperation? Our team is here to help you navigate the T4U ecosystem.
      </p>
    </div>
      ...
      <div className="space-y-6">
        <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6">
          ...
          <p className="text-sm text-slate-400 leading-relaxed">
            We are a team with advanced experience in developing complex technology startups on TON and beyond. Our focus is on building secure, transparent, and high-performance decentralized tools.
          </p>
        </div>
        ...
        <div className="relative group">
          ...
          <div className="relative bg-[#0a0a0f] rounded-2xl p-4 border border-slate-800">
            ...
            <div className="absolute -bottom-4 -right-4 bg-slate-900 border border-slate-700 px-4 py-2 rounded-lg shadow-xl">
              <p className="text-xs font-mono text-cyan-400">Ready to help! 🚁🐶</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="mt-12 text-center border-t border-slate-800/50 pt-8">
      <p className="text-xs text-slate-500 uppercase tracking-[0.2em]">
        Built by professionals • Powered by TON
      </p>
    </div>
  </div>
</div>
