            ...
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="mb-6">
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent mb-2">
                        {loginData.title} {/* Changed from t.loginToPlatform.title */}
                    </h1>
                    <p className="text-slate-400 text-sm">{loginData.subtitle}</p> {/* Changed */}
                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6">
                        <h2 className="text-lg font-semibold mb-5 text-cyan-400">
                            {loginData.stepsToBeginTrading} {/* This property exists in detailed version */}
                        </h2>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="text-sm text-slate-300 leading-relaxed pt-1">
                                    ...
                                    <div className="mt-2 bg-slate-800/50 border border-slate-700 rounded-lg px-3 py-2 inline-block">
                                        <span className="text-xs text-slate-400">{loginData.defaultCode}</span>
                                        <span className="text-cyan-400 font-mono font-semibold">{loginData.defaultCodeValue}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="text-sm text-slate-300 leading-relaxed pt-1">
                                    <span className="text-amber-400 font-medium">{loginData.step5DescriptionImportant}</span> {loginData.step5Description}
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <p className="text-sm text-slate-300 leading-relaxed pt-1">
                                    <span className="text-green-400 font-medium">{loginData.step6Description}</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-5">
                        ...
                        {/* Supported Coins */}
                        <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-5">
                            <h3 className="text-base font-semibold text-slate-300 mb-4">{loginData.supportedTradingCoins}</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                    <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-lg p-4">
                        <div className="text-xs text-cyan-400 mb-1 font-medium">{loginData.syncTime}</div>
                    ...
                    <div className="bg-gradient-to-br from-magenta-500/10 to-pink-500/10 border border-magenta-500/30 rounded-lg p-4">
                        <div className="text-xs text-magenta-400 mb-1 font-medium">{loginData.defaultReferral}</div>
                        <div className="text-lg font-bold text-white font-mono">{loginData.defaultCodeValue}</div>
                    </div>
                    <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/30 rounded-lg p-4">
                        <div className="text-xs text-green-400 mb-1 font-medium">{loginData.bestTrading}</div>
                        <div className="text-lg font-bold text-white">{loginData.t4uToken}</div>
                    </div>
                </div>
            </div>
        </div>
