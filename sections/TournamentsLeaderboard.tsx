...
const categories = [ { title: "Time Frames", desc: "Rankings filtered by Week, All Time, and specific Tournament durations.", icon: <Timer className="w-5 h-5 text-cyan-400" />, }, { title: "Token Specific", desc: "Separate leaderboards for each support token with unique statistics.", icon: <Target className="w-5 h-5 text-purple-400" />, }, { title: "Real-time PnL", desc: "User results are updated online instantly based on transaction performance.", icon: <TrendingUp className="w-5 h-5 text-emerald-400" />, }, ];
...
{/* Header Section */}
    <div className="relative mb-16">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-4xl lg:text-6xl font-bold bg-gradient-to-r from-white via-slate-100 to-slate-500 bg-clip-text text-transparent tracking-tight">
          Tournaments & Leaders
        </h1>
      </div>
    ...
    <div className="grid lg:grid-cols-5 gap-8 items-stretch">
      <div className="lg:col-span-3 bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 rounded-3xl p-8 relative overflow-hidden">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-4 p-4 bg-slate-800/30 border border-slate-700/50 rounded-xl">
            <div className="w-10 h-10 rounded-full bg-amber-500/10 flex items-center justify-center font-bold text-amber-400">1</div>
            <div>
          ...
          <div className="flex items-center gap-4 p-4 bg-slate-800/30 border border-slate-700/50 rounded-xl">
            <div className="w-10 h-10 rounded-full bg-slate-400/10 flex items-center justify-center font-bold text-slate-400">2</div>
            <div>
      ...
      <div className="lg:col-span-2 flex flex-col gap-4">
        <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6 flex-1 flex flex-col justify-center">
          ...
          <h4 className="text-xl font-bold text-white mb-4">"Leaders" Tab</h4>
